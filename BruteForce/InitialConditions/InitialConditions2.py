...
ro_lk = np.array([[0.88, 0.93, 0.92, 0.92], [0.95, 0.75, 0.98, 0.89], [0.89, 0.83, 0.95, 0.94]])

# Вероятность потери БЛА типа l при атаке кластера к
r_lk = np.array([[0.72, 0.86, 0.70, 0.74], [0.75, 0.65, 0.79, 0.69], [0.75, 0.68, 0.89, 0.71]])

# Доступное для распределения количество БЛА
A_ql = np.array([[2, 1, 3], [1, 2, 3]])

# Коэффициенты при составляющих критерия
alpha = np.array([0.2, 0.3, 0.4])

#Координаты аэродромов базирования[км]
X_q = [tg.Point(5.0, 35.0), tg.Point(100.0, 85.0)]
...
T_k = [tg.TimeGap(400, 1000), tg.TimeGap(600, 900), tg.TimeGap(500, 800), tg.TimeGap(650, 950)]
